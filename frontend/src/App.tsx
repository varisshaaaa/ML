...
function App() {
    ...
    const historyData = [
        { time: '00:00', aqi: 120 }, { time: '04:00', aqi: 110 },
        { time: '08:00', aqi: 180 }, { time: '12:00', aqi: 160 },
        { time: '16:00', aqi: 190 }, { time: '20:00', aqi: 210 },
    ]
    ...
    const fetchCityData = async (city: string) => {
        try {
            ...
            if (response.ok) {
                ...
                // Fallback for demo if API is not running or no data
                console.warn("Using mock data as API failed")
                setCurrentData({
                    city: city,
                    aqi: 155,
                    pm2_5: 68,
    ...
    const handlePredict = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                // Mock prediction
                setPrediction({
                    predicted_aqi: currentData.aqi * 1.1,
                    risk_level: 'High',
